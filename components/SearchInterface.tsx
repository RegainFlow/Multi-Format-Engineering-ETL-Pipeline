    ...
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="relative mb-6 group">
        ...
        <div className={`relative flex items-center bg-bg-secondary/90 backdrop-blur-xl border rounded-2xl overflow-hidden transition-all duration-300 ${isFocused ? 'border-primary/50 shadow-lg scale-[1.01]' : 'border-white/10'}`}>
          ...
          <input
            type="text"
            className="w-full bg-transparent border-none text-white text-lg px-4 py-5 focus:ring-0 focus:outline-none placeholder-gray-500 font-sans caret-primary"
          ...
          <div className="pr-6 flex gap-3">
            ...
            <span className="hidden md:block text-xs text-gray-500 bg-black/40 px-2 py-1.5 rounded border border-white/5 font-mono">
              /
            </span>
          </div>
        </div>
